...
countrySlugs = {
    ...
    'burkina-faso', 'burundi', 'cambodia', 'cameroon', 'canada', 'cape-verde', 'cayman islands', 'cayman-islands',
    ...
    'gambia', 'georgia', 'germany', 'ghana', 'gibraltar', 'gibraltar', 'greece', 'greenland', 'grenada', 'guadeloupe',
    'guadeloupe', 'guam', 'guatemala', 'guernsey', 'guinea', 'guinea-bissau', 'guyana', 'haiti',
    'heard-and-mcdonald-islands', 'holy-see-vatican-city-state', 'honduras', 'hong-kong-sar-china', 'hungary',
    'iceland', 'india', 'indonesia', 'iran', 'iraq', 'ireland', 'isle of man', 'isle-of-man', 'israel', 'italy',
    ...
    'marshall-islands', 'martinique', 'martinique', 'mauritania', 'mauritius', 'mayotte', 'mayotte', 'mexico',
    'micronesia', 'moldova', 'monaco', 'mongolia', 'montenegro', 'montserrat', 'montserrat', 'morocco', 'mozambique',
